        ...
        <Container>
            <Row className='py-3'>
                <Col xl={6} className="px-5 d-flex flex-column justify-content-center">
                    ...
                    <Button block variant='pallet-3 radius save-1'> Choose from Gallery </Button>
                    <p className='mt-3'>Enter the Discount : </p>
                    <Form.Select aria-label="Default select example" className='mt-3 form-control-1 radius'>
                        <option>Input Discount</option>
                        <option value="R">R</option>
                        <option value="L">L</option>
                        <option value="XL">XL</option>
                    </Form.Select>
                    <p className='mt-3'>Expired Date : </p>
                    <Form.Select aria-label="Default select example" className='mt-3 form-control-1 radius w-100 mh-100 p-2'>
                    ...
                    <Container >
                        <Row className='px-3'>
                            ...
                            <Col xl={12} className="ml-20 mt-5 space-y-5">
                                <Button block variant='pallet-2 my-4 radius save-1'> Save Promo </Button>
