				...
				<div className="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<div className="d-flex">
						<div className=' d-flex align-items-center'>
							<Button block variant='pallet-4 px-5 py-2 fs-5 rb text-pallet-1 fw-bold' padding='mx-1' >Login</Button>
						</div>
						<div className=' d-flex align-items-center'>
							<Button block variant='pallet-1 px-5 py-2 fs-5 rb' padding='mx-1' >Sign Up</Button>
						</div>
						{/* <div className='w-100'>
